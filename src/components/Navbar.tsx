    ...
    <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-6 pointer-events-none">
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-4 py-2 pl-6 pr-2 bg-white/5 border border-white/10 rounded-full hover:bg-white/10 transition-all duration-300 pointer-events-auto group shadow-xl"
        >
          <span className="text-xs font-bold text-white uppercase tracking-[0.2em]">Let's Talk</span>
          <div className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-lg shadow-[#25D366]/20 group-hover:rotate-12 transition-transform duration-500">
            <svg 
              viewBox="0 0 24 24" 
              fill="currentColor" 
              className="w-5 h-5"
