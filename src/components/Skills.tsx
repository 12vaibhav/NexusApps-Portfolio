          ...
          <div className="lg:col-span-5">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <span className="text-brand-primary font-bold tracking-[0.3em] uppercase text-sm">Expertise</span>
              </div>
              ...
              <p className="text-xl text-slate-400 leading-relaxed max-w-lg">
                We leverage the latest technologies to build high-performance digital solutions. Our tech stack is carefully selected for scalability, security, and developer experience.
              </p>
              ...
              <div className="flex flex-wrap gap-3 mt-2">
                {techStack.map((tech, i) => (
                  <motion.span
                    ...
                    className="px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-sm font-bold text-slate-300 hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-all cursor-default"
                  >
                    {tech}
                  </motion.span>
                ))}
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-end">
                    <div className="flex flex-col">
                      <span className="text-xs font-bold text-brand-primary uppercase tracking-widest mb-1">{skill.category}</span>
                      <span className="text-xl font-bold text-white tracking-tight">{skill.name}</span>
                    </div>
                    <span className="text-2xl font-black text-white/20 group-hover:text-brand-primary transition-colors duration-500">{skill.level}%</span>
                  </div>
